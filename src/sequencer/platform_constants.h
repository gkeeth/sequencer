...
#define LED_DATA_ARR (SYSCLK_FREQ_MHZ * LED_DATA_PERIOD_NS / 1000U - 1U)
#define LED_RESET_ARR (SYSCLK_FREQ_MHZ * LED_RESET_PERIOD_NS / 1000U - 1U)
#define LED_DATA0_DUTY 25U
#define LED_DATA1_DUTY 50U
#define LED_DATA0_CCR ((LED_DATA_ARR + 1U) * LED_DATA0_DUTY / 100U - 1U)
#define LED_DATA1_CCR ((LED_DATA_ARR + 1U) * LED_DATA1_DUTY / 100U - 1U)
#define LED_BUFFER_SIZE (NUM_STEPS * 3U * 8U + 1U)
#define LED_STEP_ACTIVE_RED     0xFF
...
#define LED_STEP_INACTIVE_BLUE  0xFF
